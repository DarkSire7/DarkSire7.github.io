...
const techStack = [
  ...
  { node: <TechLogo name="PyTorch" icon={siPytorch.svg} />, title: "PyTorch" },
  { node: <TechLogo name="OpenCV" icon={siOpencv.svg} />, title: "OpenCV" },
  { node: <TechLogo name="PuLP" icon={`<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="monospace" font-weight="bold" font-size="9">ILP</text></svg>`} />, title: "PuLP" },
